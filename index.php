				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<div class="graphic-content">
							<h2 class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="200ms"><span>ФотоСтудия</span> Веб-студия нового поколения</h2>
				...
				<div class="row">
                    <div class="col-md-8 col-md-offset-2 wow fadeInUp" data-wow-duration="700ms" data-wow-delay="200ms">
                        <div class="latest-title">
                            ...
                            <div class="desc-title">
                                <p>Сайты, разработанные в компании ФотоСтудия</p>
                            </div>
                        </div>
                    </div>	
					<div class="col-md-12">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5 col-sm-4">
						<div class="left-side">
							<h3>ФотоСтудия</h3>
							<p>ФотоСтудия — это команда digital-специалистов с аналитическим подходом к маркетингу, дизайну и разработке. Стремление сделать каждый проект лучшим в отрасли заставляет нас постоянно учиться, отслеживать последние тренды в digital-маркетинге и web-дизайне.</p>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="copyright-boot">
							<p>Copyright 2025 by <a href="http://bootexperts.com/">ФотоСтудия</a></p>
						</div>
					</div>
				</div>
			</div>
